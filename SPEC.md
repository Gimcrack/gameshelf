...
T37|.|F2P re-inclusion: migration `owned_games.free_to_play` bool default false; SteamClient double-fetch (base + `include_played_free_games=1`), diff marks F2P; SteamSyncer ingests F2P iff playtime > 0, V24 fresh-set = base ∪ played-F2P|V41,V24,V10,I.steam
