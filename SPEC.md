...
T29|.|manual "fix match": POST /api/library/:game_id/rematch, query-override candidate search reuses GET /api/discover/search; FE fix-match flow on detail page — override search term, results grid, select to apply|V7,V34,I.api,I.igdb
