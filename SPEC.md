...
T30|.|manual per-game IGDB refresh: POST /api/library/:game_id/refresh-igdb; FE "fetch" button on detail page (T24) to re-sync one game's IGDB data on demand|V35,I.api,I.igdb
